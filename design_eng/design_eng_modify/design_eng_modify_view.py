...
def open_modify_design_eng_window(design_eng_window):    
    create_add_modify_window(design_eng_window,DesignEng,session,field_metadata,columns_to_display,'Modify Design Engineer','Modify')
