...
## display - determines which field will appear on the main mech_con window ie: don't need to show the specifics of the address in that main mech_con window.
...
field_metadata = {
    ...
    "phone_number": {"type": Column(String(50)), "default": "", "frame": 1, "display": 1}
}

# Dynamically create the MechCon class
class MechCon(Base):
    __tablename__ = 'tblMechCon'
