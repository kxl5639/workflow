...
def open_add_proj_manager_window(proj_manager_window):    
    create_add_modify_window(proj_manager_window,ProjManager,session,field_metadata,columns_to_display,'Add New Project Manager','Add')
