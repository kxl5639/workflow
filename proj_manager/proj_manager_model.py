...
## display - determines which field will appear on the main proj_manager window ie: don't need to show the specifics of the address in that main proj_manager window.
...
# Dynamically create the ProjManager class
class ProjManager(Base):
    __tablename__ = 'tblProjManager'
