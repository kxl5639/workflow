...
def open_add_mech_eng_window(mech_eng_window):    
    create_add_modify_window(mech_eng_window,MechEng,session,field_metadata,columns_to_display,'Add New Mechanical Engineer','Add')
