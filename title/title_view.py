...
class TitleView(View):
    def __init__(self, title, parent, controller, project_number, is_root=False):
        ...
        self.initial_data_dict_list = self.update_update_stack_dict_list(self.initial_data_dict_list)
...
##############################################################################
    ...
    def on_close(self):
        self.update_update_stack_dict_list(self.to_update_stack_dict_list)
    ...
    def update_update_stack_dict_list(self, list_to_update):
    ...
    def create_n_pop_title_col_frame(self, in_row, in_column, dwgno, title, diagram_name, system_name):
        ...
        def create_title_data_frame(ridx, dwgno, title, diagram_name, system_name):
            ...
            def create_title_entry(parent, ridx):
                ...
                # title_entry.bind("<FocusOut>", lambda event: self.update_update_stack_dict_list(title_entry))
                return title_entry
            ...
            def create_diagram_combo(parent, ridx):
                ...
                # diagram_combo.bind("<FocusOut>", lambda event: self.update_update_stack_dict_list(diagram_combo))
            ...
            def create_system_combo(parent, ridx):
                ...
                # system_combo.bind("<FocusOut>", lambda event: self.update_update_stack_dict_list(system_combo))
                return system_combo
    ...
    def create_right_toolbar_frame(self):
        ...
        def move_btn_cmd(direction):
            ...
            if idx is not None:
                ...
                # # Set focus on all widgets involved to envoke update_update_stack_dict_list
                # for idx in [idx, idx_new]:
                #     for i in range(3):
                #         self.title_diagram_system_dwgno_list[idx][i].focus_set()
