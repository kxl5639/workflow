...
class ProjectDetailWindow(BaseWindow):
    ...
    #     device_frame = ttk.LabelFrame(parent, text='Add Device')
    #     ypad = 10 if row_idx == 0 else (0,10)
    #     device_frame.grid(row=row_idx, column=0, padx=10, pady=ypad)
    #     device_add_label = ttk.Label(device_frame, text='Click here to add a new device.')      
    #     device_add_label.grid(row=0,column=0,padx=10,pady=10)
