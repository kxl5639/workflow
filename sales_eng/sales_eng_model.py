...
## display - determines which field will appear on the main sales_eng window ie: don't need to show the specifics of the address in that main sales_eng window.
