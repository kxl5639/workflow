...
def open_modify_sales_eng_window(sales_eng_window):    
    create_add_modify_window(sales_eng_window,SalesEng,session,field_metadata,columns_to_display,'Modify Sales Engineer','Modify')
